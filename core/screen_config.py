...
class ScreenConfigManager(QObject):
    ...
    def set_config(self, brand: Optional[str], model: Optional[str], width: int, height: int, rotate: int = 0, screen_name: Optional[str] = None):
...
def set_screen_config(brand: Optional[str], model: Optional[str], width: int, height: int, rotate: int = 0, screen_name: Optional[str] = None):
    manager = get_screen_config_manager()
    manager.set_config(brand, model, width, height, rotate, screen_name)
