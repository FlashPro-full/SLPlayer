...
class WeatherPropertiesComponent(BasePropertiesComponent):
    ...
    def init_ui(self):
        ...
        self.weather_coords_x.setMinimumWidth(60)
        self.weather_coords_x.setText("0")
        coords_comma = QLabel(",")
        self.weather_coords_y = QLineEdit()
        self.weather_coords_y.setPlaceholderText("0")
        self.weather_coords_y.setMinimumWidth(60)
        self.weather_coords_y.setText("0")
        coords_layout.addWidget(coords_label)
        coords_layout.addWidget(self.weather_coords_x)
        ...
        self.weather_dims_width.setMinimumWidth(60)
        self.weather_dims_width.setText("1920")
        dims_comma = QLabel(",")
        self.weather_dims_height = QLineEdit()
        self.weather_dims_height.setPlaceholderText("1080")
        self.weather_dims_height.setMinimumWidth(60)
        self.weather_dims_height.setText("1080")
        dims_layout.addWidget(dims_label)
        dims_layout.addWidget(self.weather_dims_width)
        dims_layout.addWidget(dims_comma)
        dims_layout.addWidget(self.weather_dims_height)
        ...
        frame_checkbox_layout.addWidget(self.weather_frame_checkbox)
        ...
        if borders:
            self.weather_frame_border_combo.addItems(["---"] + borders)
        else:
            self.weather_frame_border_combo.addItems(["---", "000", "001", "002", "003"])
        self.weather_frame_border_combo.setCurrentText("---")
        self.weather_frame_border_combo.setEnabled(False)
        self.weather_frame_border_combo.currentTextChanged.connect(self._on_frame_border_changed)
        ...
        self.weather_frame_effect_combo.setEnabled(False)
        ...
        self.weather_frame_speed_combo.setEnabled(False)
    ...
    def update_properties(self):
        ...
        self.weather_frame_effect_combo.setEnabled(frame_enabled)
        self.weather_frame_speed_combo.setEnabled(frame_enabled)
        
        border = frame_props.get("border", "---") if isinstance(frame_props, dict) else "---"
        border_index = self.weather_frame_border_combo.findText(border)
        if border_index >= 0:
            self.weather_frame_border_combo.setCurrentIndex(border_index)
        else:
            self.weather_frame_border_combo.setCurrentIndex(0)
        ...
        if effect_index >= 0:
            ...
            self.weather_frame_effect_combo.setCurrentIndex(0)
