...
_STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "toolbar.send": {"en": "Update program on controller via network", "it": "Aggiorna programma sul controller via rete", "pl": "Aktualizuj program na kontrolerze przez sieć"},
    "toolbar.insert": {"en": "Add program to controller via network", "it": "Aggiungi programma al controller via rete", "pl": "Dodaj program na kontrolerze przez sieć"},
    ...
    "label.send": {"en": "Update", "it": "Aggiorna", "pl": "Aktualizuj"},
    "label.insert": {"en": "Add", "it": "Aggiungi", "pl": "Dodaj"},
